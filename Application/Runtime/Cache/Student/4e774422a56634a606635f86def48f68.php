                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li><a class="menu-top-active" href="">Select Course</a></li>
                            <li><a href="/index.php/Student/Search">Search Course</a></li>
                            <li><a href="/index.php/Student/Score">Scores</a></li>
        ...
        <div class="container">
            ...
            <div class="col-md-6">
              ...
              <div class="panel-body">
                <form action="/index.php/Student/Select/SelectCourse" method="post" id="SelectCourse">
                  <div class="col-md-10">
                    <input type="text" class="form-control" id="course_id" name="course_id" placeholder="请输入课号" />
                    <p><p>
                    <input type="text" class="form-control" id="teacher_id" name="teacher_id" placeholder="请输入教师号" />
                    <p><p>
                  </div>
                  <div class="col-md-1">
            ...
            <div class="col-md-6">
              ...
              <div class="panel-body">
                <form action="/index.php/Student/Select/DeleteCourse" method="post" id="DeleteCourse">
                  <div class="col-md-10">
                    <input type="text" class="form-control" id="course_id" name="course_id" placeholder="请输入课号" />
                    <p><p>
                    <input type="text" class="form-control" id="teacher_id" name="teacher_id" placeholder="请输入教师号" />
