...
<body>
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li><a class="menu-top-active" href="">Manage</a></li>
                            <li><a href="/index.php/Admin/Search">Search Course</a></li>
                            <li><a href="/index.php/Admin/Score">Scores</a></li>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="page-head-line">Select Page</h4>
            ...
            <div class="col-md-13">
              ...
              <div class="col-md-6">
                ...
                <div class="panel-body">
                  <form action="/index.php/Admin/Manage/OpenCourse" method="post" id="SelectCourse">
                    <div class="col-md-5">
                      课程号:<input type="text" class="form-control" id="course_id" name="course_id" placeholder="请输入课号" />
                      <p><p>
                      课程名:<input type="text" class="form-control" id="Admin_id" name="Admin_id" placeholder="请输入课程名" />
                      <p><p>
                      学分:<input type="text" class="form-control" id="Admin_id" name="Admin_id" placeholder="请输入学分" />
                      <p><p>


                    </div>
                    <div class="col-md-5">
                      价格:<input type="text" class="form-control" id="Admin_id" name="Admin_id" placeholder="请输入价格" />
                      <p><p>
                      院系号:<input type="text" class="form-control" id="Admin_id" name="Admin_id" placeholder="请输入院系号" />
